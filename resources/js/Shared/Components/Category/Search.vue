    ...
    <div class="container">
        ...
        <div class="search-n-filter-area home-one">
            <div class="search-box">
                <Link href="/" aria-label="Filter Icon" class="filter_btn btn--radius btn--bg-white btn--box-shadow btn--size-40-40 filter-back-btn">
        ...
        <transition name="bounce" enter-active-class="animate__animated animate__fadeInDown" leave-active-class="animate__animated animate__fadeOutUp">
                            ...
                            <div class="shop-filter-block mt-0">
                                ...
                                <div class="shop-filter-block__content">
                                    <div class="widget-price-range">
                                        <Slider :format="{ prefix: 'Rp ', thousand: ',', decimals: 0 }" v-model="sliderDefault" :max="sliderMax" :default="sliderDefault" class="slider-red" />
                                    </div>
                                </div>
                            </div>
